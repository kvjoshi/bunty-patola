...
<section class="bg-dark text-light header-inner p-0 jarallax o-hidden" data-overlay data-jarallax data-speed="0.2">
    <img src="assets/images/process0.webp" alt="Image" class="jarallax-img opacity-30">
    <div class="container py-0 layer-2 p-4">
        <div class="row my-3">
            <div class="col">
        ...
        <div class="row my-4 my-md-6" data-aos="fade-up">
            <div class="col-lg-9 col-xl-8">
                <h1 class="display-4">Process Of Making Patola</h1>
                <p class="lead mb-0">
                    The Patola, a hand made Silken Textile manufactured at Patan, in North Gujarat is an art. Historically atleast several centuries old it is recorded in the religious books like Ramayan and Narsinha Puran that Patola were used in great ceremony and in the marriage as a holy charm dressing.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="divider">
        <img src="assets/img/dividers/divider-4.svg" alt="graphical divider" data-inject-svg />
    </div>
</section>
...
<section>
    <div class="container" data-aos="fade-up">
        <div class="row align-items-center justify-content-around">
            <div class="col-md-4 col-12 col-xl-5 mb-4 mb-md-0">
                <img src="assets/images/ach1.jpeg" alt="Image" class="rounded shadow-3d">
            </div>
            <div class="col-md-8  col-12 col-xl-7">
                <div class="row justify-content-center">
                    <div class="col-xl-11 col-lg-11">

                        <div class="my-2">
                            <span class="h3">Creating design by tying nits on warp and weft.</span>
                        </div>
                        <p class="lead">Warp and weft silk threads are tied separately with cotton thread on the portions already marked out in conformity with the proposed design in the fabric. This tied portion is meant to remain unexposed to the colour while dyeing. United portion which has absorbed one colour, may be tied while dyeing in another colour. Typing tied separately with cotton thread on the portions already marked out in conformity with the proposed design in the fabric. This tied portion is meant to remain unexposed to the colour while dyeing. United portion which has absorbed one colour, may be tied while dyeing in another colour. Tyeing untying, retying and dyeing in different shades are the main features of this process.</p>
        ...
        <div class="row align-items-center justify-content-around">
            ...
            <div class="col-md-8 col-12 col-xl-7">
                <div class="row justify-content-center align-content-between">
                    <div class="col-xl-11 col-lg-11">
                        <div class="my-2">
                            <span class="h3">Dyeing Process</span>
                        </div>
                        <p class="lead">After completion of dyeing work of warps and wefts, the threads of the warp of different repeats of a pattern are put together in a sequence on the loom, so that the design becomes visible. The threads of wefts are wound on to bobbins and kept in the bamboo shuttle for weaving process.
                        </p>
            ...
            <div class="col-md-8 col-12 col-xl-7">
                <div class="row justify-content-center">
                    <div class="col-xl-11 col-lg-11">
                        ...
                        <div class="my-3">
                            <span class="h3">Adjusting the design </span>
                        </div>
                        <p class="lead">
...
<section>
    <div class="container" data-aos="fade-up">
        <div class="row align-items-center justify-content-around">
            <div class="col-md-5 col-12 col-xl-5 mb-4 mb-md-0">
                <img src="assets/images/ach1.jpeg" alt="Image" class="rounded shadow-3d h-100">
            </div>
            <div class="col-md-7 col-12 col-xl-7">
                <div class="row justify-content-center">
                    <div class="col-xl-11 col-lg-11">
                        <div class="my-3">
                            <span class="h3">Traditional patola</span>
                        </div>
                        <p class="lead">
                            It takes three to four months to prepare tie-dyed design on warp and weft threads for one saree of 6 yards length by 48” width. Two salvis(weavers) working together weave just about 8” to 9” a day. It takes 40 to 50 days to weave a sari. Thus 4 to 5 persians take a period of 5 to 6 months to complete a saree depending on the design.
                        </p>
