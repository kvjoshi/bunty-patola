    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-5 col-lg-6 col-md-8">
                <h1 class="display-4">Product Cat</h1>
                <p class="lead mb-0">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium.</p>
            </div>
        </div>
    </div>
    <div class="divider">
...
<section>
    <div class="container">
        <div class="row mb-4" data-isotope-collection data-sort-ascending="true">
            <div class="col-md-6 col-lg-4 text-center mb-3" data-isotope-item>
