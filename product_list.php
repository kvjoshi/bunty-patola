...
<section class="pt-5">
    <div class="container">
        ...
        <div class="row" data-isotope-collection data-isotope-id="cat">
            <?php while ($row=mysqli_fetch_assoc($pc_query)){ ?>
            <div class="col-sm-6 mb-4 text-center" data-isotope-item>
                <a href="product_list1.php">
                    <img src="uploads/<?php echo $row['pc_img']; ?>" alt="Single Ikkat" class="rounded shadow-3d mb-3">
            ...
            <div class="col-sm-6 mb-4 text-center" data-isotope-item>
                <a href="product_list1.php">
                    <img src="assets/images/patola-cover1.jpg" alt="Single Ikkat" class="rounded shadow-3d mb-3">
            ...
            <div class="col-sm-6 mb-4 text-center" data-isotope-item>
                <a href="product_list1.php">
                    <img src="assets/images/patola-cover2.jpg" alt="Double Ikkat" class="rounded  shadow-3d mb-3">
