...
if(isset($_POST['add_s'])){
    ...
    $add_sql="INSERT INTO `cos_service` (c_name, c_desc) VALUES ('$title','$desc')";
...
if(isset($_GET['del'])){
    ...
    $del_sql="DELETE FROM `cos_service` WHERE `c_id` = '$del_id'";
...
<div class="page-wrapper" id="page-wrapper">
    ...
    <main class="content">
                    ...
                    <div class="col-md-5 d-flex justify-content-end h-md-down">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb no-padding bg-trans mb-30">
                                ...
                                <li class="breadcrumb-item active">Cosmetic</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="portlet-box portlet-gutter  mb-10 row">
                            ...
                            <div class="portlet-body row align-content-center">
                                <div class="col-lg-10 col-md-10 col-sm-10">
                                    <button type="button" class="btn btn-icon btn-lg btn-light-primary mb-30" data-toggle="modal" data-target="#cos_add">
                                        <i class="icon-Add"></i>
                                        Add Service
                                    </button>
                                </div>
                    ...
                    <table id="data-table" class="table mb-0 table-striped" cellspacing="0" width="100%">
                        ...
                        <?php while ($row=mysqli_fetch_assoc($s_query)){
                            ...
                            <tr>
                                ...
                                <td><a href="service_edit.php?cos_s=<?php echo $row['c_id'];?>" class="btn btn-icon btn-rounded btn-success ml-1">
                                        <i class="fa fa-pencil-alt"></i>
                                        Edit
                                    </a>
                                </td>
                                <td>
                                    <a href="?del=<?php echo $row['c_id'];?>" class="btn btn-icon btn-rounded btn-danger ml-1">
        ...
        <div class="modal fade" id="cos_add" tabindex="-1" role="dialog" aria-labelledby="cos_addTitle" aria-hidden="true">
