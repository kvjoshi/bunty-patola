...
$wx=0;
$s_sql="SELECT * FROM `weight_service`";
...
if(isset($_POST['add_s'])){
    ...
    $add_sql="INSERT INTO `weight_service` (w_name, w_desc) VALUES ('$title','$desc')";
...
if(isset($_GET['del'])){
    ...
    $del_sql="DELETE FROM `weight_service` WHERE `w_id` = '$del_id'";
...
<head>
    ...
    <title>Weight Management Services</title>
    <!-- Bootstrap-->
...
<div class="page-wrapper" id="page-wrapper">
    ...
    <main class="content">
                            ...
                            <div class="list-item pl-0">
                                ...
                                <div class="list-body">
                                    <div class="list-title fs-2x">
                                        <h3>Weight Management Services</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-5 d-flex justify-content-end h-md-down">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb no-padding bg-trans mb-30">
                                ...
                                <li class="breadcrumb-item active">Weight Management</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="portlet-box portlet-gutter  mb-10 row">
                            ...
                            <div class="portlet-body row align-content-center">
                                <div class="col-lg-10 col-md-10 col-sm-10">
                                    <button type="button" class="btn btn-icon btn-lg btn-light-primary mb-30" data-toggle="modal" data-target="#weight_add">
                                        <i class="icon-Add"></i>
                                        Add Service
                                    </button>
                                </div>
                    ...
                    <table id="data-table" class="table mb-0 table-striped" cellspacing="0" width="100%">
                        ...
                        <?php while ($row=mysqli_fetch_assoc($s_query)){
                            ...
                            <tr>
                                ...
                                <td><a href="service_edit.php?weight_s=<?php echo $row['w_id'];?>" class="btn btn-icon btn-rounded btn-success ml-1">
                                        <i class="fa fa-pencil-alt"></i>
                                        Edit
                                    </a>
                                </td>
                                <td>
                                    <a href="?del=<?php echo $row['w_id'];?>" class="btn btn-icon btn-rounded btn-danger ml-1">
        ...
        <div class="modal fade" id="weight_add" tabindex="-1" role="dialog" aria-labelledby="weight_addTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Add Weight Management Service</h5>
