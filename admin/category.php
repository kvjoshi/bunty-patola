...
if(isset($_GET['del'])){
    ...
    $del_sql="DELETE FROM `product_cat` WHERE `pc_id` = '$del_id'";
        ...
        <div class="page-content">
            <div class="container-fluid">
                        ...
                        <div class="portlet-box portlet-gutter  mb-10 row">
                            <div class="portlet-header flex-row flex d-flex align-items-center b-b">
                                <div class="flex d-flex flex-column">
                                    <h3>Total Live Product Categories</h3>
                                </div>
                            </div>
                ...
                <div class="bg-white table-responsive rounded shadow-sm pt-3 pb-3 mb-30 row">
                    <h6 class="pl-3 pr-3 text-capitalize font400 mb-20">Product Category List</h6>
                    <table id="data-table" class="table mb-0 table-striped" cellspacing="0" width="100%">
                        ...
                        <?php while ($row=mysqli_fetch_assoc($pc_query)){
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo $row['pc_img'];?>" target="_blank" >Click To View</a></td>

                                <td><?php echo $row['pc_create_date'];?></td>
                                <td>
                                    <a href="?del=<?php echo $row['pc_id'];?>" class="btn btn-icon btn-rounded btn-danger ml-1">
        ...
        <div class="modal fade" id="product_modal" tabindex="-1" role="dialog" aria-labelledby="product_modalTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form method="post" action="category_up.php"  enctype="multipart/form-data" >
                        <div class="modal-body">
                            <div class="form-group">
                                <label>Product Category Title</label>
                                <input type="text" class="form-control" name="pc_name" placeholder="Product Category Title">
                            </div>

                            <div class="form-group">
                                <label>Product Category Description</label>
                                <textarea class="form-control" name="pc_desc"></textarea>
                            </div>
                            <div class="form-group">
